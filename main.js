var Nsme_of_The_Guest_Array = [];
function Submit(){
    var Guest_name = doucemt.getElementById("Enter_name").value;
    Name_of_The_Guest_Array.push(Guest_name);
    doucemt.getElementById(Display_names).innHTML = Nsme_of_The_Guest_Array;
    console.log(Name_of_The_Guest_Array);
    var length_of_the_array = Nsme_of_The_Guest_Array.length;
